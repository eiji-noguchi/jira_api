# Generated by Django 3.1 on 2021-07-07 13:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Task',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('af51339f-81ff-4667-94c5-bc27026b6645'), editable=False, primary_key=True, serialize=False)),
                ('task', models.CharField(max_length=100)),
                ('description', models.CharField(max_length=300)),
                ('criteria', models.CharField(max_length=100)),
                ('status', models.CharField(choices=[('1', 'まだやらん'), ('2', 'がんばってる'), ('1', 'おわった')], default='1', max_length=40)),
